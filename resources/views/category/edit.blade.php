...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Master Category</h4> </div>
    ...
    <div class="col-md-6">
        <form action="/category/{{$category->id}}/update" method="POST">
            ...
            <div class="form-group{{$errors->has('kode') ? 'has-error' : ''}}">
                ...
                <input name="kode" type="text" class="form-control" id="kode" value="{{$category->kode}}">
                @if($errors->has('kode'))
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" class="form-control" id="nama" value="{{$category->nama}}" required>
            </div>
            <div class="form-group">
                <label for="keterangan" class="control-label">Keterangan</label>
                <textarea type="text" name="keterangan" class="form-control" id="keterangan">{{$category->keterangan}}</textarea>
            </div>
