...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="#">Form Downtime</a></li>
        </ol>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-md-6">
        <form method="POST" action="/downtime/create">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" onclick="return confirm('Apakah anda ingin menyimpan data ini ??')">Simpan</button>
            </div>
        </form>
    </div>
</div>
