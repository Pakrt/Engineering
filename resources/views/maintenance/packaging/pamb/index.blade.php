...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title text-white">Komponen PAM B</h4> </div>
                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/history/{{$pamb->id_komponen}}/detail">{{$pamb->alias}}</a></td>
                                <td><a href="/history/{{$pamb->id_komponen}}/detail">{{$pamb->komponen}}</a></td>
                                <td>
                                    <a href="/component/{{$pamb->id}}/detail" class="btn btn-success"> <i class="mdi mdi-eye"></i> </a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
