...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title text-white">Komponen Powder 1</h4> </div>
                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/history/{{$powder1->id_komponen}}/detail">{{$powder1->alias}}</a></td>
                                <td><a href="/history/{{$powder1->id_komponen}}/detail">{{$powder1->komponen}}</a></td>
                                <td>
                                    <a href="/component/{{$powder1->id}}/detail" class="btn btn-success"> <i class="mdi mdi-eye"></i> </a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
