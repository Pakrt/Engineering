...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title text-white">Komponen Konveyor Tf. Cooling</h4> </div>
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Konveyor Tf. Cooling</li>
        </ol>
    </div>
    <!-- /.col-lg-12 -->
</div>
            ...
            <div class="white-box">
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($transfercooling as $transfercooling)
                            <tr>
                                <th scope="row">&emsp; {{ $loop->iteration}}</th>
                                <td><a href="/history/{{$transfercooling->id_komponen}}/detail">{{$transfercooling->id_komponen}}</a></td>
                                <td><a href="/history/{{$transfercooling->id_komponen}}/detail">{{$transfercooling->alias}}</a></td>
